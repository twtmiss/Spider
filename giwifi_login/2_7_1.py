...
url = "http://10.21.0.2:8062/redirect"
...
def get_rel_url():
    ...
    req=urllib.request.Request("http://10.21.0.2:8062/redirect")
    header={
...
def login():
    ...
    #POST发送登陆数据
    req=urllib.request.Request('http://login.gwifi.com.cn/cmps/admin.php/api/loginaction?round=307')
